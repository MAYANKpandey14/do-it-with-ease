...
>(({ className, priority, ...props }, ref) => {
  ...
  return (
    <CheckboxPrimitive.Root
      ref={ref}
      className={cn(
        "peer h-3 w-3 shrink-0 rounded-sm border border-primary ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50",
        getPriorityColors(),
        className
      )}
      {...props}
