...
const TaskCard = ({ task }: TaskCardProps) => {
  ...
  return (
    <>
      <Card className={cn(
        "transition-all duration-200 hover:shadow-lg border-l-4 group",
        ...
        <CardContent className="p-5">
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1 min-w-0 space-y-3">
              ...
              <div>
                <h3 className={cn(
                  "font-semibold text-lg leading-tight break-words",
                ...
                {task.description && (
                  <p className={cn(
                    "text-muted-foreground mt-2 text-sm leading-relaxed break-words",
              ...
              <div className="flex flex-wrap items-center gap-3">
                <Badge className={cn('px-3 py-1 text-xs font-medium', getPriorityColor(task.priority))}>
                  {task.priority}
                </Badge>
            ...
            <div className="flex items-center space-x-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
              <Button 
                ...
                className={cn('touch-target text-muted-foreground hover:text-foreground', getFocusRing())}
              >
